...
class MemoryStream:
    ...
    def get_recent_memories(self, hours_back: int = 24, limit: int = 50) -> List[Memory]:
        ...
        recent_memories = [
            memory for memory in self.observations + self.reflections
    ...
    def get_memories_by_importance(self, min_importance: float = 5.0, hours_back: int = 24) -> List[Memory]:
        """获取重要的记忆"""
        cutoff_time = GameTime.now() - timedelta(hours=hours_back)
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        stop_words = {'i', 'me', 'my', 'myself', 'we', 'our', 'ours', 'ourselves', 
                     ...
                     'by', 'for', 'with', 'through', 'during', 'before', 
                     'after', 'above', 'below', 'up', 'down', 'in', 'out', 
